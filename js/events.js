function clickEvent(id){
  $(id).click(function(){
    $.ajax({
      type: "POST",
      url: "http://www.nitred,com/api/clickEvent",
...
function registerUserAndCookie(button_id, input_id){
  $(button_id).click(function(){
    ...
    $.ajax({
      type: "POST",
      url: "http://www.nitred,com/api/registerUserAndCookie",
      contentType: "application/json; charset=utf-8",
      ...
      success: function(data){
        ...
        setTimeout(function(){
          window.location.href = "http://www.nitred,com/page1.html";
        }, 1200);
      },
      dataType: "json"
    });
...
function registerAction(cookie_id, action, details){
  $.ajax({
    type: "POST",
    url: "http://www.nitred,com/api/registerAction",
    contentType: "application/json; charset=utf-8",
...
function getAllPaths() {
  $.ajax({
    type: "POST",
    url: "http://www.nitred,com/api/getAllPaths",
    contentType: "application/json; charset=utf-8",
    data: null,
    success: function(data){
      console.log(data);
